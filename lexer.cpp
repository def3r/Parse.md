...
void Lexer::FormatCorrectionInit() {
  int index = -1;
  correction = 0;
...
bool Lexer::FetchMarker(std::deque<Stack>& backupStack) {
...
void Lexer::StackCorrection(Stack& HighItem, Stack& LowItem) {
